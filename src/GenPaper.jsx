...
const GenPaperA = (url1, url2) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        const tryCombine = () => {
            if (cropped1 && cropped2 && cropped3 && cropped4 && bgLoaded) {
...
const GenPaperB = (url1, url2) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        const tryCombine = () => {
            if (cropped1 && cropped2 && cropped3 && bgLoaded) {
                const finalCanvas = document.createElement("canvas");
                finalCanvas.width = 2000;
                finalCanvas.height = 2000;
                const ctx = finalCanvas.getContext("2d");
                                                    ...
                                                    imgJ.onload = () => {
                                                        imgK.onload = () => {
                                                            imgL.onload = () => {
                                                                ...
                                                                ctx.drawImage(imgD, 1000, 500, 1000, 1000);
                                                                ctx.drawImage(imgE, 0, -500, 1000, 1000);
                                                                ctx.drawImage(imgF, 250, -500, 1000, 1000);
                                                                ctx.drawImage(imgG, 500, -500, 1000, 1000);
                                                                ctx.drawImage(imgH, 1000, -500, 1000, 1000);
                                                                ctx.drawImage(imgI, 0, 1500, 1000, 1000);
                                                                ctx.drawImage(imgJ, 250, 1500, 1000, 1000);
                                                                ctx.drawImage(imgK, 500, 1500, 1000, 1000);
                                                                ctx.drawImage(imgL, 1000, 1500, 1000, 1000);
                                                                const finalUrl = finalCanvas.toDataURL();
                                                                resolve(finalUrl);
                                                            }
                                                            imgL.src = cropped12
                        ...
                        imgC.onload = () => {
                            imgD.onload = () => {
                                imgE.onload = () => {
                                    ctx.drawImage(imgA, 500, 500, 1000, 1000);
                                    ctx.drawImage(imgB, 500, -500, 1000, 1000);
                                    ctx.drawImage(imgC, 500, 1500, 1000, 1000);
                                    ctx.drawImage(imgD, 1500, 500, 1000, 1000);
                                    ctx.drawImage(imgE, -500, 1000, 1000, 1000);
                                    const finalUrl = finalCanvas.toDataURL();
                                    resolve(finalUrl);
        ...
        const tryCombine = () => {
            if (cropped1 && cropped2 && cropped3 && bgLoaded) {
                ...
                imgA.onload = () => {
                    imgB.onload = () => {
                        imgC.onload = () => {
                            ctx.drawImage(imgA, 1000, 1000, 1000, 1000);
                            ctx.drawImage(imgB, 1000, 0, 1000, 1000);
                            ...
                            imgD.onload = () => {
                                imgE.onload = () => {
                                    imgF.onload = () => {
                                        imgG.onload = () => {
                                            imgH.onload = () => {
                                                ctx.drawImage(imgA, 1500, 0, 1000, 1000);
                                                ctx.drawImage(imgB, -500, 0, 1000, 1000);
                                                ctx.drawImage(imgC, 500, 0, 1000, 1000);
                                                ctx.drawImage(imgD, 500, 0, 1000, 1000);
                                                ctx.drawImage(imgE, 0, 1500, 1000, 1000);
                                                ctx.drawImage(imgF, 1000, 1500, 1000, 1000);
                                                ctx.drawImage(imgG, -500, 1000, 1000, 1000);
                                                ctx.drawImage(imgH, 1500, 1000, 1000, 1000);
                                                const finalUrl = finalCanvas.toDataURL();
                                                resolve(finalUrl);
                                            }
                                            imgH.src = cropped8
                                ...
                                imgE.onload = () => {
                                    imgF.onload = () => {
                                        imgG.onload = () => {
                                            ...
                                            ctx.drawImage(imgB, 500, -500, 1000, 1000);
                                            ctx.drawImage(imgC, 500, -500, 1000, 1000);
                                            ctx.drawImage(imgD, -500, 500, 1000, 1000);
                                            ctx.drawImage(imgE, -500, -500, 1000, 1000);
                        ...
                        imgC.onload = () => {
                            imgD.onload = () => {
                                imgE.onload = () => {
                                    imgF.onload = () => {
                                        imgG.onload = () => {
                                            ctx.drawImage(imgA, -250, -500, 1000, 1000);
                                            ctx.drawImage(imgB, -250, 500, 1000, 1000);
